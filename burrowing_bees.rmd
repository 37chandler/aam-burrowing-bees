...
Welcome to the "Burrowing Bees" assignment, which is required for Quantitative Methods. 
...
the holes and 1 in another; it doesn’t matter which holes or which bees.

## Goal

Let’s use a simulation to estimate if the bees are behaving randomly. 
In order to do this, you will need to write a script that simulates a 
...
1.	Set up a way to do the actual selection of holes. Check out `sample`.
